      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-6">
            <img src={assetUrl('images/logo-footer.png')} alt="TWC Logo" className="h-20 w-auto brightness-0 invert" />
        ...
        <div className="mt-16 pt-8 border-t border-primary-foreground/20 text-sm text-primary-foreground/60 flex flex-col md:flex-row justify-between items-center gap-4">
          <p>© {new Date().getFullYear()} Together We Can Rehabilitation. All rights reserved.</p>
          <p className="text-primary-foreground/40">Faith-based, community-led healing.</p>
        </div>
      </div>
    </footer>
  );
